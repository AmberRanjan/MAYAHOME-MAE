...
Mobile.verifyElementExist(findTestObject('MAE/Validation/Chat/No Messages Yet'), GlobalVariable.Timeout)

Mobile.verifyElementExist(findTestObject('MAE/Validation/Chat/No Messages Yet Page'), GlobalVariable.Timeout)
